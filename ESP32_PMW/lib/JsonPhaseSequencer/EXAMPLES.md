...
```json
[
  { "method": "addCarrierDutyCycleTask", "channels": 0, "value": 50.0 },
  { "method": "addWaitTask", "duration_ms": 500 },
  { "method": "addCarrierDutyCycleTask", "channels": 0, "value": 80.0 }
]
```
...
```json
[
  { "method": "addDutyCycleTask", "channels": 1, "value": 60.0 },
  { "method": "addCarrierDutyCycleTask", "channels": 2, "value": 90.0 },
  { "method": "addWaitTask", "duration_ms": 1000 },
  { "method": "addCarrierDutyCycleTask", "channels": 2, "value": 10.0 }
]
```
