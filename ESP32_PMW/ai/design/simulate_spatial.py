...
Usage:
    uv run python ai/design/simulate_spatial.py [--live] [--grad]
"""
...
from ai.design.spatial_model import make_state
from ai.design.spatial_mpc import closed_loop, default_mpc
