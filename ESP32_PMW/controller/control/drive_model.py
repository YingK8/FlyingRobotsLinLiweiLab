...
# Measured per channel. The spread is real, not rounding: the four channels differ.
R_CHANNEL = 15.0        # ohm, mean of 12.6 to 18
L_CHANNEL = 6.7e-3      # H, mean of 6.64 to 6.85
V_RAIL = 12.0           # V, net VM1
V_RAIL_MAX = 20.0       # V, VNH5019 ceiling before overvoltage risk
