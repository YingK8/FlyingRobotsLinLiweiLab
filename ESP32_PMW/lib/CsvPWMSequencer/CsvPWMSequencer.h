...
public:
  ...
  // Load waypoints from a CSV file (SPIFFS) and compile the sequence. Header
  // row is `time,channel,duty,carrier_duty,frequency,phase`; optional
  ...
  // Returns false if the file can't be opened, has no rows, or its first
