...
`experiment`) -- e.g. tools/gen_solo_sweep_experiment.py's or
tools/gen_coupling_experiment.py's output.
...
(optionally) builds+flashes, EN-pulse resets (tools/serial_comm.py's
