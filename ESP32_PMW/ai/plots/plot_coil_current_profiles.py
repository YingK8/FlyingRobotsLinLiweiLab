...
(ai/gen_coupling_experiment.py's fixed 5s-slot layout, segment centers
verified against ai/coupling_matrix.py's --t0=12.0/--slot=5.0 defaults).
...
# segment centers (s), per ai/coupling_matrix.py's --t0=12.0/--slot=5.0
