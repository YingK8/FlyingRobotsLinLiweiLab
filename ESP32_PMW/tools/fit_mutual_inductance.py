...
Usage:
  uv run python tools/fit_mutual_inductance.py picoscope_capture.csv \
      --driven A --probed B --v-channel "Channel B" --freq-hz 150 --duty 30 \
      --v-supply 11.9 --rlc-fit tools/rlc_fit.json --out tools/m_matrix.json
"""
...
def main() -> None:
    ...
    ap.add_argument("--rlc-fit", required=True,
                     help="tools/rlc_fit.json from tools/fit_rlc_model.py -- "
